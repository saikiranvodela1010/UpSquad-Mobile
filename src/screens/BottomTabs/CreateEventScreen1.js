...
export default class CreateEventScreen extends React.Component {
    ...
    onSubmit() {
        ...
        if (this.state.eventname === "") {
            this.setState({ eventnameerr: "Please enter your event name" });
        }
        ...
        if (this.state.emailData === "") {
            this.setState({signupemailerr:"Please enter your email"})
        ...
        if (this.state.registeremail === "") {
            this.setState({registeremailerr:"Please enter your email"})
        ...
        return (
            <View style={{ flex: 1, backgroundColor: '#FFFFFF' }}>
                ...
                <View style={{ flex: 1, justifyContent: 'flex-end' }}>
                    ...
                    style={{ borderWidth: 1, borderRadius: 30, borderColor: 'rgba(241, 241, 241, 1)', backgroundColor: 'rgba(241, 241, 241, 1)', height: '18%', width: '85%', alignItems: 'center', justifyContent: 'center', marginLeft: 'auto', marginRight: 'auto', marginBottom: 30 }}
                    >
                    <View>
