      ...
      if (response.status == 'No network Connected!') {
        ...
        if (response.data.length === 0) {
          ...
          if (
            ...
            const response = await this.apiHandler.requestGet(
              data,
              this.serviceUrls.validateEmail,
            );
          ...
          <ScrollView style={{marginBottom: 20, marginTop: 10}}>
            ...
            <View style={({flexDirection: 'row', flex: 1}, {height: 60})}>
              <FloatingLabelInput
                ...
                label={'Community subscription code'}
            ...
            <View
              ...
              <TouchableOpacity
                ...
                <Image
                  resizeMode="contain"
                  source={
                    this.state.checkmarkName === 'mark-on'
                      ? ImagesWrapper.checkmark
                      : ImagesWrapper.checkbox
                  }
                  style={[
                    this.state.checkmarkName === 'mark-on'
                      ? styles.checkmark
            ...
            <TouchableOpacity
              ...
              <LinearGradient
                ...
                style={[
                  ...
                  Platform.OS === 'ios' ? {marginTop: '5%'} : {marginTop: '5%'},
                ]}>
